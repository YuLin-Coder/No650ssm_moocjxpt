...
<body>
	...
	<div class="page-container">
		...
		<form action="course/deleteCourseByIds.action" method="post" id="myform" name="myform">
			<table class="table table-border table-bordered table-bg">
				...
				<c:forEach items="${courseList}" var="course">
					<tr class="text-c">
						<td><input type="checkbox" value="${course.courseid}" name="courseid"></td>
						...
						<td>${course.memo}</td>
						<td><a href="course/getCourseById.action?id=${course.courseid}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>&nbsp;&nbsp;<a
							href="course/deleteCourse.action?id=${course.courseid}" onclick="{if(confirm('确定要删除吗?')){return true;}return false;}" title="删除"><i
