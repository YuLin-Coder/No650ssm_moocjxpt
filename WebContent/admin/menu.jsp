...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-member">
			<dt>
				<i class="Hui-iconfont">&#xe62d;</i>学生用户信息管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a data-href="users/getAllUsers.action" data-title="学生用户列表" href="javascript:void(0)">学生用户信息列表</a></li>
					<li><a data-href="users/queryUsersByCond.action" data-title="学生用户查询" href="javascript:void(0)">学生用户信息查询</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu">
			<dt>
				<i class="Hui-iconfont">&#xe62d;</i>课程章节信息管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a data-href="sectionx/getAllSectionx.action" data-title="课程章节列表" href="javascript:void(0)">课程章节信息列表</a></li>
					<li><a data-href="sectionx/querySectionxByCond.action" data-title="课程章节查询" href="javascript:void(0)">课程章节信息查询</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu">
			<dt>
				<i class="Hui-iconfont">&#xe62d;</i>学生成绩信息管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a data-href="score/getAllScore.action" data-title="学生成绩列表" href="javascript:void(0)">学生成绩信息列表</a></li>
					<li><a data-href="score/queryScoreByCond.action" data-title="学生成绩查询" href="javascript:void(0)">学生成绩信息查询</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu">
			<dt>
				<i class="Hui-iconfont">&#xe62d;</i>视频课件信息管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a data-href="vedio/getAllVedio.action" data-title="视频课件列表" href="javascript:void(0)">视频课件信息列表</a></li>
					<li><a data-href="vedio/queryVedioByCond.action" data-title="视频课件查询" href="javascript:void(0)">视频课件信息查询</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu">
			<dt>
				<i class="Hui-iconfont">&#xe62d;</i>学生留言信息管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a data-href="topic/getAllTopic.action" data-title="学生留言列表" href="javascript:void(0)">学生留言信息列表</a></li>
					<li><a data-href="topic/queryTopicByCond.action" data-title="学生留言查询" href="javascript:void(0)">学生留言信息查询</a></li>
				</ul>
			</dd>
		</dl>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu">
			<dt>
				<i class="Hui-iconfont">&#xe62d;</i>教师用户信息管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
		...
		<dl id="menu">
			...
			<dd>
				<ul>
					<li><a data-href="sectionx/createSectionx.action" data-title="新增课程章节" href="javascript:void(0)">新增课程章节信息</a></li>
					<li><a data-href="sectionx/getMySectionx.action" data-title="课程章节列表" href="javascript:void(0)">课程章节信息列表</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu">
			...
			<dd>
				<ul>
					<li><a data-href="score/createScore.action" data-title="新增学生成绩" href="javascript:void(0)">新增学生成绩信息</a></li>
					<li><a data-href="score/getMyScore.action" data-title="学生成绩列表" href="javascript:void(0)">学生成绩信息列表</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu">
			...
			<dd>
				<ul>
					<li><a data-href="vedio/createVedio.action" data-title="新增视频课件" href="javascript:void(0)">新增视频课件信息</a></li>
					<li><a data-href="vedio/getMyVedio.action" data-title="视频课件列表" href="javascript:void(0)">视频课件信息列表</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu">
			...
			<dd>
				<ul>
					<li><a data-href="topic/getMyTopic.action" data-title="学生留言列表" href="javascript:void(0)">学生留言信息列表</a></li>
				</ul>
			</dd>
		</dl>
