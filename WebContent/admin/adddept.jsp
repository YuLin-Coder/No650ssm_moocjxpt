...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>院系管理 <span class="c-gray en">&gt;</span> 新增院系 <a
			class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="dept/createDept.action" title="刷新"><i
		...
		<form class="form form-horizontal" id="form-article-add" action="dept/addDept.action" name="myform" method="post">
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="deptname" class="input-text" id="deptname" placeholder="请输入院系名称" />
				</div>
			</div>
			<div class="row cl">
