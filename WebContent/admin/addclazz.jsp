...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>班级管理 <span class="c-gray en">&gt;</span> 新增班级 <a
			class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="clazz/createClazz.action" title="刷新"><i
			class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="clazz/addClazz.action" name="myform" method="post">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">班级名称</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="clazzname" class="input-text" id="clazzname" placeholder="请输入班级名称" />
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<span class="select-box"><select name="deptid" class="select" id="deptid"><option value="">---请选择院系--</option>
