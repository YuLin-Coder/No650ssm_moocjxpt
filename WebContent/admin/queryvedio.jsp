...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>视频课件管理 <span class="c-gray en">&gt;</span> 视频课件查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="7">视频课件查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${vedioList}" var="vedio">
				<tr class="text-c">
					<td class="center">${vedio.vedioname}</td>
					<td class="center">${vedio.coursename}</td>
					<td class="center">${vedio.sectionxname}</td>
					<td class="center">${vedio.addtime}</td>
					<td class="center">${vedio.hits}</td>
				</tr>
			</c:forEach>
		</table>
		<div class="cl pd-5 mt-20"></div>
		<div class="text-c">
			<form action="vedio/queryVedioByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						<option value="vedioname">按标题查询</option>
