...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>课程章节管理 <span class="c-gray en">&gt;</span> 课程章节查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="4">课程章节查询</th>
				</tr>
				<tr class="text-c">
					<th class="center">章节名</th>
					<th class="center">课程</th>
					<th class="center">备注</th>
				</tr>
			</thead>
			<c:forEach items="${sectionxList}" var="sectionx">
				<tr class="text-c">
					<td class="center">${sectionx.sectionxname}</td>
					<td class="center">${sectionx.coursename}</td>
					<td class="center">${sectionx.memo}</td>
				</tr>
			</c:forEach>
		</table>
		<div class="cl pd-5 mt-20"></div>
		<div class="text-c">
			<form action="sectionx/querySectionxByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						<option value="sectionxname">按章节名查询</option>
