...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>教师管理 <span class="c-gray en">&gt;</span> 新增教师 <a
			class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="teacher/createTeacher.action" title="刷新"><i
	...
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="teacher/addTeacher.action" name="myform" method="post">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="teachername" class="input-text" id="teachername" placeholder="请输入姓名" />
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					...
					<textarea class="textarea" name="contents" id="contents" placeholder="请输入教师介绍"> </textarea>
