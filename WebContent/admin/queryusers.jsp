...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>学生用户管理 <span class="c-gray en">&gt;</span> 学生用户查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="12">学生用户查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${usersList}" var="users">
				<tr class="text-c">
					...
					<td class="center">${users.clazzname}</td>
