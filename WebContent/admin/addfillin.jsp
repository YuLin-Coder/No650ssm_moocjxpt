...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>填空题管理 <span class="c-gray en">&gt;</span> 新增填空题 <a
			class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="fillin/createFillin.action" title="刷新"><i
			class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="fillin/addFillin.action" name="myform" method="post">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">题目</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="question" class="input-text" id="question" placeholder="请输入题目" />
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">正确答案</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="correct" class="input-text" id="correct" placeholder="请输入正确答案" />
				</div>
			</div>
			<div class="row cl">
