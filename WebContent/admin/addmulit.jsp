...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>多选题管理 <span class="c-gray en">&gt;</span> 新增多选题 <a
			class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="mulit/createMulit.action" title="刷新"><i
			class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="mulit/addMulit.action" name="myform" method="post">
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="answere" class="input-text" id="answere" placeholder="请输入答案E" />
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="parsing" class="input-text" id="parsing" placeholder="请输入解析" />
				</div>
			</div>
