...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>教师管理 <span class="c-gray en">&gt;</span> 教师查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="10">教师查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${teacherList}" var="teacher">
				<tr class="text-c">
					...
					<td class="center">${teacher.teachername}</td>
					<td class="center">${teacher.sex}</td>
					<td class="center">${teacher.birthday}</td>
					<td class="center">${teacher.graduate}</td>
		...
		<div class="text-c">
			<form action="teacher/queryTeacherByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						...
						<option value="teachername">按姓名查询</option>
