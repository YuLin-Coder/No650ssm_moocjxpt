...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>班级管理 <span class="c-gray en">&gt;</span> 班级查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="6">班级查询</th>
				</tr>
				<tr class="text-c">
					<th class="center">班级名称</th>
					<th class="center">负责人</th>
					<th class="center">创建日期</th>
					<th class="center">院系</th>
			...
			<c:forEach items="${clazzList}" var="clazz">
				<tr class="text-c">
					...
					<td class="center">${clazz.manager}</td>
					<td class="center">${clazz.addtime}</td>
					<td class="center">${clazz.deptname}</td>
		...
		<div class="text-c">
			<form action="clazz/queryClazzByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						...
						<option value="deptid">按院系查询</option>
