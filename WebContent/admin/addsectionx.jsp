...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>课程章节管理 <span class="c-gray en">&gt;</span> 新增课程章节 <a
			class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="sectionx/createSectionx.action" title="刷新"><i
			class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="sectionx/addSectionx.action" name="myform" method="post">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">章节名</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="sectionxname" class="input-text" id="sectionxname" placeholder="请输入章节名" />
				</div>
			</div>
			<div class="row cl">
