...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>院系管理 <span class="c-gray en">&gt;</span> 编辑院系<a
			class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="dept/getDeptById.action?id=${dept.deptid }" title="刷新">
			<i class="Hui-iconfont">&#xe68f;</i>
		</a> &nbsp;&nbsp; &nbsp;<a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="dept/getAllDept.action"
		...
		<form class="form form-horizontal" id="form-article-add" action="dept/updateDept.action" name="myform" method="post">
			...
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<input type="hidden" name="deptid" id="deptid" value="${dept.deptid}" /> <input type="hidden" id="basepath" value="<%=basePath%>" />
